...
def make_plot():
    ...
    savefig('PCM1_TF_Sim2_1-140.svg', transparent=True, bbox_inches='tight')
    savefig('PCM1_TF_Sim2_1-140.png', transparent=True, bbox_inches='tight')
    savefig('PCM1_TF_Sim2_1-140.pdf', transparent=True, bbox_inches='tight')
    ...
    savefig('PCM1_TF_Sim2_1-20.svg', transparent=True, bbox_inches='tight')
    savefig('PCM1_TF_Sim2_1-20.png', transparent=True, bbox_inches='tight')
    savefig('PCM1_TF_Sim2_1-20.pdf', transparent=True, bbox_inches='tight')
