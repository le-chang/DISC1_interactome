...
def make_plot():
    ...
    legend( ['OE PCM1','OE BBS4', 'OE DISC1', 'KO PCM1','KO BBS4', 'KO DISC1'], loc='upper center', bbox_to_anchor=(0.5, -0.15), ncol=3, fontsize=8)
    title( ' Effect of perturbation of genes on migration \n Functional module 1, Simulation 2', fontsize=10 )
    ...
    savefig('PCM1_gene_Sim2_1-140.svg', transparent=True, bbox_inches='tight')
    savefig('PCM1_gene_Sim2_1-140.png', transparent=True, bbox_inches='tight')
    savefig('PCM1_gene_Sim2_1-140.pdf', transparent=True, bbox_inches='tight')
    ...
    savefig('PCM1_gene_Sim2_1-20.svg',  transparent=True, bbox_inches='tight')
    savefig('PCM1_gene_Sim2_1-20.png',  transparent=True, bbox_inches='tight')
    savefig('PCM1_gene_Sim2_1-20.pdf',  transparent=True, bbox_inches='tight')
