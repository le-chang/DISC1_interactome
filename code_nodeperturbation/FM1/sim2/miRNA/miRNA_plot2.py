...
def make_plot():
    ...
    savefig('PCM1_miRNA_Sim2_1-140-plot2.svg', transparent=True, bbox_inches='tight')
    savefig('PCM1_miRNA_Sim2_1-140-plot2.png', transparent=True, bbox_inches='tight')
    savefig('PCM1_miRNA_Sim2_1-140-plot2.pdf', transparent=True, bbox_inches='tight')
    ...
    savefig('PCM1_miRNA_Sim2_1-20-plot2.svg',  transparent=True, bbox_inches='tight')
    savefig('PCM1_miRNA_Sim2_1-20-plot2.png',  transparent=True, bbox_inches='tight')
    savefig('PCM1_miRNA_Sim2_1-20-plot2.pdf',  transparent=True, bbox_inches='tight')
    #
