...
def make_plot():
    ...
    savefig('PCM1_miRNA_Sim4_1-140-plot1.svg', transparent=True, bbox_inches='tight')
    savefig('PCM1_miRNA_Sim4_1-140-plot1.png', transparent=True, bbox_inches='tight')
    savefig('PCM1_miRNA_Sim4_1-140-plot1.pdf', transparent=True, bbox_inches='tight')
    ...
    savefig('PCM1_miRNA_Sim4_1-20-plot1.svg',  transparent=True, bbox_inches='tight')
    savefig('PCM1_miRNA_Sim4_1-20-plot1.png',  transparent=True, bbox_inches='tight')
    savefig('PCM1_miRNA_Sim4_1-20-plot1.pdf',  transparent=True, bbox_inches='tight')
