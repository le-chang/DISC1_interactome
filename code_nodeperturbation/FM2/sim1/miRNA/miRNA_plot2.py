...
def make_plot():
    ...
    legend( ['OE miR143','OE miR106a', 'OE miR130a','OE miR125b', 'OE miR20b', 'OE miR320a', 'OE miR223', 'KO miR143', 'KO miR106a', 'OE miR130a', 'KO miR125b', 'KO miR20b', 'KO miR320a', 'KO miR223'], loc='upper center', bbox_to_anchor=(0.5, -0.18), ncol=4, fontsize=7 )
    ...
    savefig('ZNF365_miRNA_Sim1_1-140_plot2.svg', transparent=True, bbox_inches='tight')
    savefig('ZNF365_miRNA_Sim1_1-140_plot2.png', transparent=True, bbox_inches='tight')
    savefig('ZNF365_miRNA_Sim1_1-140_plot2.pdf', transparent=True, bbox_inches='tight') 
    #
    ...
    savefig('ZNF365_miRNA_Sim1_1-20_plot2.svg',  transparent=True, bbox_inches='tight')
    savefig('ZNF365_miRNA_Sim1_1-20_plot2.png',  transparent=True, bbox_inches='tight')
    savefig('ZNF365_miRNA_Sim1_1-20_plot2.pdf',  transparent=True, bbox_inches='tight')
