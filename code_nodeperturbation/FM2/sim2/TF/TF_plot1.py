...
def make_plot():
    ...
    legend( ['OE SMAD2','OE SMAD3', 'OE STAT3', 'OE KLF4', 'OE TCF3', 'OE TAL1','KO SMAD2','KO SMAD3', 'KO STAT3', 'KO KLF4', 'KO TCF3', 'KO TAL1'], loc='upper center', bbox_to_anchor=(0.5, -0.18), ncol=4, fontsize=7 )
    ...
    savefig('ZNF365_TF_Sim2_1-140_plot1.svg', transparent=True, bbox_inches='tight')
    savefig('ZNF365_TF_Sim2_1-140_plot1.png', transparent=True, bbox_inches='tight')
    savefig('ZNF365_TF_Sim2_1-140_plot1.pdf', transparent=True, bbox_inches='tight')
    # ) 
    #
    ...
    savefig('ZNF365_TF_Sim2_1-20_plot1.svg',  transparent=True, bbox_inches='tight')
    savefig('ZNF365_TF_Sim2_1-20_plot1.png',  transparent=True, bbox_inches='tight')
    savefig('ZNF365_TF_Sim2_1-20_plot1.pdf',  transparent=True, bbox_inches='tight')
