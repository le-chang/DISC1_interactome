...
def make_plot():
    ...
    savefig('ZNF365_TF_Sim2_1-140_plot2.svg', transparent=True, bbox_inches='tight')
    savefig('ZNF365_TF_Sim2_1-140_plot2.png', transparent=True, bbox_inches='tight')
    savefig('ZNF365_TF_Sim2_1-140_plot2.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('ZNF365_TF_Sim2_1-20_plot2.svg',  transparent=True, bbox_inches='tight')
    savefig('ZNF365_TF_Sim2_1-20_plot2.png',  transparent=True, bbox_inches='tight')
    savefig('ZNF365_TF_Sim2_1-20_plot2.pdf',  transparent=True, bbox_inches='tight')
