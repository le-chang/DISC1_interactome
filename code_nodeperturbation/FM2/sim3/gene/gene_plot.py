...
def make_plot():
    ...
    legend(['OE ZNF365','OE GSK3B', 'OE DISC1','OE NDEL1', 'OE PAFAH1B1','KO ZNF365','KO GSK3B', 'KO DISC1', 'KO NDEL1', 'KO PAFAH1B1'], loc='upper center', bbox_to_anchor=(0.5, -0.15), ncol=4, fontsize=7) 
    ...
    savefig('ZNF365_gene_Sim3_1-140.svg', transparent=True, bbox_inches='tight')
    savefig('ZNF365_gene_Sim3_1-140.png', transparent=True, bbox_inches='tight')
    savefig('ZNF365_gene_Sim3_1-140.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('ZNF365_gene_Sim3_1-20.svg',  transparent=True, bbox_inches='tight')
    savefig('ZNF365_gene_Sim3_1-20.png',  transparent=True, bbox_inches='tight')
    savefig('ZNF365_gene_Sim3_1-20.pdf',  transparent=True, bbox_inches='tight')
