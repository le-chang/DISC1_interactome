...
def make_plot():
    ...
    savefig('ZNF365_gene_Sim4_1-140.svg', transparent=True, bbox_inches='tight')
    savefig('ZNF365_gene_Sim4_1-140.png', transparent=True, bbox_inches='tight')
    savefig('ZNF365_gene_Sim4_1-140.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('ZNF365_gene_Sim4_1-20.svg',  transparent=True, bbox_inches='tight')
    savefig('ZNF365_gene_Sim4_1-20.png',  transparent=True, bbox_inches='tight')
    savefig('ZNF365_gene_Sim4_1-20.pdf',  transparent=True, bbox_inches='tight')
