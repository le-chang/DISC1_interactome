...
def make_plot():
    ...
    ps = [  plot( mig1, 'go-',markersize=3, linewidth=0.2  ), plot( mig2, 'ro-',markersize=3, linewidth=0.2  ),plot( mig3,'bo-',markersize=3, linewidth=0.2 ),\
        ...
        plot( mig9, 'b^-',markersize=3, linewidth=0.2), plot( mig11, 'y^-',markersize=3, linewidth=0.2), plot( mig10, 'c^-',markersize=3, linewidth=0.2 ), \
        plot( mig11, color='orange', marker='^', linestyle='-',markersize=3, linewidth=0.2 ), plot( mig12, color='aliceblue', marker='^', linestyle='-',markersize=3, linewidth=0.2)]
    legend( ['OE miR155','OE miR103a', 'OE miR20a', 'OE miR10b', 'OE miR145', 'OE miR188','KO miR155','KO miR103a', 'KO miR20a', 'KO miR10b', 'KO miR145', 'KO miR188'], loc='upper center', bbox_to_anchor=(0.5, -0.18), ncol=4, fontsize=7)
    title( ' Effect of perturbation of miRNAs on migration \n Functional module 2, Simulation 4', fontsize=10  )
    ...
    savefig('ZNF365_miRNA_Sim4_1-140_plot1.svg', transparent=True, bbox_inches='tight')
    savefig('ZNF365_miRNA_Sim4_1-140_plot1.png', transparent=True, bbox_inches='tight')
    savefig('ZNF365_miRNA_Sim4_1-140_plot1.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('ZNF365_miRNA_Sim4_1-20_plot1.svg',  transparent=True, bbox_inches='tight')
    savefig('ZNF365_miRNA_Sim4_1-20_plot1.png',  transparent=True, bbox_inches='tight')
    savefig('ZNF365_miRNA_Sim4_1-20_plot1.pdf',  transparent=True, bbox_inches='tight')
