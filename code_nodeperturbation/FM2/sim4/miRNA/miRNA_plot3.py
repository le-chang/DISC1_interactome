...
def make_plot():
    ...
    legend( ['OE miR33b','OE miR17', 'KO miR33b', 'KO miR17'], loc='upper center', bbox_to_anchor=(0.5, -0.15), ncol=2, fontsize=8 )
    ...
    savefig('ZNF365_miRNA_Sim4_1-140_plot3.svg', transparent=True, bbox_inches='tight')
    savefig('ZNF365_miRNA_Sim4_1-140_plot3.png', transparent=True, bbox_inches='tight')
    savefig('ZNF365_miRNA_Sim4_1-140_plot3.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('ZNF365_miRNA_Sim4_1-20_plot3.svg',  transparent=True, bbox_inches='tight')
    savefig('ZNF365_miRNA_Sim4_1-20_plot3.png',  transparent=True, bbox_inches='tight')
    savefig('ZNF365_miRNA_Sim4_1-20_plot3.pdf',  transparent=True, bbox_inches='tight')
