...
def make_plot():
    ...
    legend( ['OE CREB1','OE CCND1', 'OE KLF4','OE SMAD2', 'OE SMAD3', 'KO CREB1','KO CCND1', 'KO KLF4', 'KO SMAD2', 'KO SMAD3'], loc='upper center', bbox_to_anchor=(0.5, -0.15), ncol=4, fontsize=7 )
    ...
    savefig('CDK5_TF_Sim1_1-140_plot1.svg', transparent=True, bbox_inches='tight')
    savefig('CDK5_TF_Sim1_1-140_plot1.png', transparent=True, bbox_inches='tight')
    savefig('CDK5_TF_Sim1_1-140_plot1.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('CDK5_TF_Sim1_1-20_plot1.svg',  transparent=True, bbox_inches='tight')
    savefig('CDK5_TF_Sim1_1-20_plot1.png',  transparent=True, bbox_inches='tight')
    savefig('CDK5_TF_Sim1_1-20_plot1.pdf',  transparent=True, bbox_inches='tight')
