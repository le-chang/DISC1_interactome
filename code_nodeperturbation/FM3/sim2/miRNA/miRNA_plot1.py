...
def make_plot():
    ...
    savefig('CDK5_miRNA_Sim2_1-140_plot1.svg', transparent=True, bbox_inches='tight')
    savefig('CDK5_miRNA_Sim2_1-140_plot1.png', transparent=True, bbox_inches='tight')
    savefig('CDK5_miRNA_Sim2_1-140_plot1.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('CDK5_miRNA_Sim2_1-20_plot1.svg',  transparent=True, bbox_inches='tight')
    savefig('CDK5_miRNA_Sim2_1-20_plot1.png',  transparent=True, bbox_inches='tight')
    savefig('CDK5_miRNA_Sim2_1-20_plot1.pdf',  transparent=True, bbox_inches='tight')
