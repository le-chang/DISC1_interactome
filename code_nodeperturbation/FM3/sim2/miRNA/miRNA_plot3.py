...
def make_plot():
    ...
    savefig('CDK5_miRNA_Sim2_1-140_plot3.svg', transparent=True, bbox_inches='tight')
    savefig('CDK5_miRNA_Sim2_1-140_plot3.png', transparent=True, bbox_inches='tight')
    savefig('CDK5_miRNA_Sim2_1-140_plot3.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('CDK5_miRNA_Sim2_1-20_plot3.svg',  transparent=True, bbox_inches='tight')
    savefig('CDK5_miRNA_Sim2_1-20_plot3.png',  transparent=True, bbox_inches='tight')
    savefig('CDK5_miRNA_Sim2_1-20_plot3.pdf',  transparent=True, bbox_inches='tight')
