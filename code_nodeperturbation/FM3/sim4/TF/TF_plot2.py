...
def make_plot():
    ...
    legend( ['OE RXR','OE POU5F1', 'OE TAL1','OE TCF3', 'OE STAT3','KO RXR','KO POU5F1', 'KO TAL1', 'KO TCF3', 'KO STAT3'], loc='upper center', bbox_to_anchor=(0.5, -0.15), ncol=4, fontsize=7 )
    ...
    savefig('CDK5_TF_Sim4_1-140_plot2.svg', transparent=True, bbox_inches='tight')
    savefig('CDK5_TF_Sim4_1-140_plot2.png', transparent=True, bbox_inches='tight')
    savefig('CDK5_TF_Sim4_1-140_plot2.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('CDK5_TF_Sim4_1-20_plot2.svg',  transparent=True, bbox_inches='tight')
    savefig('CDK5_TF_Sim4_1-20_plot2.png',  transparent=True, bbox_inches='tight')
    savefig('CDK5_TF_Sim4_1-20_plot2.pdf',  transparent=True, bbox_inches='tight')
