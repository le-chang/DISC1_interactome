...
def make_plot():
    ...
    legend( ['OE miR155','OE miR103a', 'OE miR33b','OE miR20a', 'OE miR17', 'OE miR145', 'OE miR10b','KO miR155','KO miR103a', 'KO miR33b', 'KO miR20a', 'KO miR17', 'KO miR145', 'KO miR10b'], loc='upper center', bbox_to_anchor=(0.5, -0.18), ncol=4, fontsize=7 )
    title( ' Effect of perturbation of miRNAs on migration \n Functional module 3, Simulation 4', fontsize=10  )
    ...
    savefig('CDK5_miRNA_Sim4_1-140_plot1.svg', transparent=True, bbox_inches='tight')
    savefig('CDK5_miRNA_Sim4_1-140_plot1.png', transparent=True, bbox_inches='tight')
    savefig('CDK5_miRNA_Sim4_1-140_plot1.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('CDK5_miRNA_Sim4_1-20_plot1.svg',  transparent=True, bbox_inches='tight')
    savefig('CDK5_miRNA_Sim4_1-20_plot1.png',  transparent=True, bbox_inches='tight')
    savefig('CDK5_miRNA_Sim4_1-20_plot1.pdf',  transparent=True, bbox_inches='tight')
