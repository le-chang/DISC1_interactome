...
def make_plot():
    ...
    legend( ['OE miR188','OE miR143', 'OE miR423', 'OE miR223', 'OE miR320a','KO miR188','KO miR143', 'KO miR423', 'KO miR223', 'KO miR320a'], loc='upper center', bbox_to_anchor=(0.5, -0.18), ncol=4, fontsize=7  )
    ...
    savefig('CDK5_miRNA_Sim4_1-140_plot2.svg', transparent=True, bbox_inches='tight')
    savefig('CDK5_miRNA_Sim4_1-140_plot2.png', transparent=True, bbox_inches='tight')
    savefig('CDK5_miRNA_Sim4_1-140_plot2.pdf', transparent=True, bbox_inches='tight') 
    #
    ...
    savefig('CDK5_miRNA_Sim4_1-20_plot2.svg',  transparent=True, bbox_inches='tight')
    savefig('CDK5_miRNA_Sim4_1-20_plot2.png',  transparent=True, bbox_inches='tight')
    savefig('CDK5_miRNA_Sim4_1-20_plot2.pdf',  transparent=True, bbox_inches='tight')
