...
def make_plot():
    ...
    legend( ['OE miR106a','OE miR130a','OE miR125b', 'OE miR20b', 'KO miR106a','KO miR130a', 'KO miR125b', 'KO miR20b'], loc='upper center', bbox_to_anchor=(0.5, -0.15), ncol=4, fontsize=7 )
    ...
    savefig('CDK5_miRNA_Sim4_1-140_plot3.svg', transparent=True, bbox_inches='tight')
    savefig('CDK5_miRNA_Sim4_1-140_plot3.png', transparent=True, bbox_inches='tight')
    savefig('CDK5_miRNA_Sim4_1-140_plot3.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('CDK5_miRNA_Sim4_1-20_plot3.svg',  transparent=True, bbox_inches='tight')
    savefig('CDK5_miRNA_Sim4_1-20_plot3.png',  transparent=True, bbox_inches='tight')
    savefig('CDK5_miRNA_Sim4_1-20_plot3.pdf',  transparent=True, bbox_inches='tight')
