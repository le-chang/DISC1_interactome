...
def make_plot():
    ...
    savefig('APP_TF_Sim1_1-140_plot1.svg', transparent=True, bbox_inches='tight')
    savefig('APP_TF_Sim1_1-140_plot1.png', transparent=True, bbox_inches='tight')
    savefig('APP_TF_Sim1_1-140_plot1.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('APP_TF_Sim1_1-20_plot1.svg',  transparent=True, bbox_inches='tight')
    savefig('APP_TF_Sim1_1-20_plot1.png',  transparent=True, bbox_inches='tight')
    savefig('APP_TF_Sim1_1-20_plot1.pdf',  transparent=True, bbox_inches='tight')
