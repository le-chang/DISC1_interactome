...
def make_plot():
    ...
    legend( ['OE POU5F1','OE TAL1', 'OE TCF3','OE CREB1','KO POU5F1','KO TAL1', 'KO TCF3', 'KO CREB1'], loc='upper center', bbox_to_anchor=(0.5, -0.15), ncol=4, fontsize=7 )
    ...
    savefig('APP_TF_Sim1_1-140_plot2.svg', transparent=True, bbox_inches='tight')
    savefig('APP_TF_Sim1_1-140_plot2.png', transparent=True, bbox_inches='tight')
    savefig('APP_TF_Sim1_1-140_plot2.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('APP_TF_Sim1_1-20_plot2.svg',  transparent=True, bbox_inches='tight')
    savefig('APP_TF_Sim1_1-20_plot2.png',  transparent=True, bbox_inches='tight')
    savefig('APP_TF_Sim1_1-20_plot2.pdf',  transparent=True, bbox_inches='tight')
