...
def make_plot():
    ...
    legend( ['OE miR130a', 'OE miR125b','OE miR20b', 'OE miR10b', 'OE miR223', 'OE miR320a', 'KO miR130a', 'KO miR125b', 'KO miR20b', 'KO miR10b', 'KO miR223', 'KO miR320a'], loc='upper center', bbox_to_anchor=(0.5, -0.15), ncol=4, fontsize=7)
    ...
    savefig('APP_miRNA_Sim1_1-140_plot2.svg', transparent=True, bbox_inches='tight')
    savefig('APP_miRNA_Sim1_1-140_plot2.png', transparent=True, bbox_inches='tight')
    savefig('APP_miRNA_Sim1_1-140_plot2.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('APP_miRNA_Sim1_1-20_plot2.svg',  transparent=True, bbox_inches='tight')
    savefig('APP_miRNA_Sim1_1-20_plot2.png',  transparent=True, bbox_inches='tight')
    savefig('APP_miRNA_Sim1_1-20_plot2.pdf',  transparent=True, bbox_inches='tight')
