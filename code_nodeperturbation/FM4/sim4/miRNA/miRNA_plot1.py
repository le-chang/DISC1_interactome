...
def make_plot():
    ...
    legend( ['OE miR20a','OE miR17', 'OE miR188','OE miR106a', 'OE miR145', 'OE miR143', 'OE miR155','KO miR20a','KO miR17', 'KO miR188', 'KO miR106a', 'KO miR145', 'KO miR143', 'KO miR155'], loc='upper center', bbox_to_anchor=(0.5, -0.15), ncol=4, fontsize=7 )
    title( ' Effect of perturbation of miRNAs on migration \n Functional module 4, Simulation 4', fontsize=10  )
    ...
    savefig('APP_miRNA_Sim4_1-140_plot1.svg', transparent=True, bbox_inches='tight')
    savefig('APP_miRNA_Sim4_1-140_plot1.png', transparent=True, bbox_inches='tight')
    savefig('APP_miRNA_Sim4_1-140_plot1.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('APP_miRNA_Sim4_1-20_plot1.svg',  transparent=True, bbox_inches='tight')
    savefig('APP_miRNA_Sim4_1-20_plot1.png',  transparent=True, bbox_inches='tight')
    savefig('APP_miRNA_Sim4_1-20_plot1.pdf',  transparent=True, bbox_inches='tight')
