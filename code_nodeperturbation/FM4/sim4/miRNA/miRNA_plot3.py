...
def make_plot():
    ...
    savefig('APP_miRNA_Sim4_1-140_plot3.svg', transparent=True, bbox_inches='tight')
    savefig('APP_miRNA_Sim4_1-140_plot3.png', transparent=True, bbox_inches='tight')
    savefig('APP_miRNA_Sim4_1-140_plot3.pdf', transparent=True, bbox_inches='tight')
    ...
    savefig('APP_miRNA_Sim4_1-20_plot3.svg',  transparent=True, bbox_inches='tight')
    savefig('APP_miRNA_Sim4_1-20_plot3.png',  transparent=True, bbox_inches='tight')
    savefig('APP_miRNA_Sim4_1-20_plot3.pdf',  transparent=True, bbox_inches='tight')
