...
def make_plot():
    ...
    legend( ['OE CCND1','OE SMAD2', 'OE SMAD3','OE STAT3', 'OE KLF4', 'KO CCND1','KO SMAD2', 'KO SMAD3', 'KO STAT3', 'KO KLF4'], loc='upper center', bbox_to_anchor=(0.5, -0.15), ncol=4, fontsize=7 )
    ...
    savefig('APP_TF_Sim4_1-140_plot1.svg', transparent=True, bbox_inches='tight')
    savefig('APP_TF_Sim4_1-140_plot1.png', transparent=True, bbox_inches='tight')
    savefig('APP_TF_Sim4_1-140_plot1.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('APP_TF_Sim4_1-20_plot1.svg',  transparent=True, bbox_inches='tight')
    savefig('APP_TF_Sim4_1-20_plot1.png',  transparent=True, bbox_inches='tight')
    savefig('APP_TF_Sim4_1-20_plot1.pdf',  transparent=True, bbox_inches='tight')
