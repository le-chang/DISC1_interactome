...
def make_plot():
    ...
    savefig('CCDC141_gene_Sim1_1-140.svg', transparent=True, bbox_inches='tight')
    savefig('CCDC141_gene_Sim1_1-140.png', transparent=True, bbox_inches='tight')
    savefig('CCDC141_gene_Sim1_1-140.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('CCDC141_gene_Sim1_1-20.svg',  transparent=True, bbox_inches='tight')
    savefig('CCDC141_gene_Sim1_1-20.png',  transparent=True, bbox_inches='tight')
    savefig('CCDC141_gene_Sim1_1-20.pdf',  transparent=True, bbox_inches='tight')
