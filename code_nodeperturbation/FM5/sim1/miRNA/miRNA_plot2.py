...
def make_plot():
    ...
    savefig('CCDC141_miRNA_Sim1_1-140-plot2.svg', transparent=True, bbox_inches='tight')
    savefig('CCDC141_miRNA_Sim1_1-140-plot2.png', transparent=True, bbox_inches='tight')
    savefig('CCDC141_miRNA_Sim1_1-140-plot2.pdf', transparent=True, bbox_inches='tight')
    ...
    savefig('CCDC141_miRNA_Sim1_1-20-plot2.svg',  transparent=True, bbox_inches='tight')
    savefig('CCDC141_miRNA_Sim1_1-20-plot2.png',  transparent=True, bbox_inches='tight')
    savefig('CCDC141_miRNA_Sim1_1-20-plot2.pdf',  transparent=True, bbox_inches='tight')
    #
    # Plotting Migration (OFF)
    #
    #subplot(122)
