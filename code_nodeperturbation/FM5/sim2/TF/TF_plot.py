...
def make_plot():
    ...
    legend( ['OE RXR','OE TAL1', 'OE TCF3','OE STAT3', 'KO RXR','KO TAL1', 'KO TCF3', 'KO STAT3'], loc='upper center', bbox_to_anchor=(0.5, -0.15), ncol=4, fontsize=7 )
    ...
    savefig('CCDC141_TF_Sim2_1-140.svg', transparent=True, bbox_inches='tight')
    savefig('CCDC141_TF_Sim2_1-140.png', transparent=True, bbox_inches='tight')
    savefig('CCDC141_TF_Sim2_1-140.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('CCDC141_TF_Sim2_1-20.svg',  transparent=True, bbox_inches='tight')
    savefig('CCDC141_TF_Sim2_1-20.png',  transparent=True, bbox_inches='tight')
    savefig('CCDC141_TF_Sim2_1-20.pdf',  transparent=True, bbox_inches='tight')
