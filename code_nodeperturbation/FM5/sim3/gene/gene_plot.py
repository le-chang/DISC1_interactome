...
def make_plot():
    ...
    legend( ['OE DISC1','OE CCDC141', 'OE MYH2', 'KO DISC1', 'KO CCDC141', 'KO MYH2'], loc='upper center', bbox_to_anchor=(0.5, -0.15), ncol=3, fontsize=7 )
    ...
    savefig('CCDC141_gene_Sim3_1-140.svg', transparent=True, bbox_inches='tight')
    savefig('CCDC141_gene_Sim3_1-140.png', transparent=True, bbox_inches='tight')
    savefig('CCDC141_gene_Sim3_1-140.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('CCDC141_gene_Sim3_1-20.svg',  transparent=True, bbox_inches='tight')
    savefig('CCDC141_gene_Sim3_1-20.png',  transparent=True, bbox_inches='tight')
    savefig('CCDC141_gene_Sim3_1-20.pdf',  transparent=True, bbox_inches='tight')
