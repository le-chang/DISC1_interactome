...
def make_plot():
    ...
    ylim( (-0.1, 1.1) ) 
    xlim( (-0.1, 140) )
    legend( ['OE miR223','OE miR320a', 'OE miR155','OE miR106a', 'OE miR20a', 'OE miR17', 'KO miR223','KO miR320a', 'KO miR155', 'KO miR106a', 'KO miR20a', 'KO miR17'], loc='upper center', bbox_to_anchor=(0.5, -0.18), ncol=4, fontsize=7 )
    title( ' Effect of perturbation of miRNAs on migration \n Functional module 5, Simulation 3', fontsize=10 )
    ...
    savefig('CCDC141_miRNA_Sim3_1-140-plot1.svg', transparent=True, bbox_inches='tight')
    savefig('CCDC141_miRNA_Sim3_1-140-plot1.png', transparent=True, bbox_inches='tight')
    savefig('CCDC141_miRNA_Sim3_1-140-plot1.pdf', transparent=True, bbox_inches='tight')
    ...
    savefig('CCDC141_miRNA_Sim3_1-20-plot1.svg',  transparent=True, bbox_inches='tight')
    savefig('CCDC141_miRNA_Sim3_1-20-plot1.png',  transparent=True, bbox_inches='tight')
    savefig('CCDC141_miRNA_Sim3_1-20-plot1.pdf',  transparent=True, bbox_inches='tight')
    #
    # Plotting Migration (OFF)
    #
    #subplot(122)
