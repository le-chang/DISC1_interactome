...
def make_plot():
    ...
    savefig('ACTB_miRNA_Sim1_1-140-plot3.svg', transparent=True, bbox_inches='tight')
    savefig('ACTB_miRNA_Sim1_1-140-plot3.png', transparent=True, bbox_inches='tight')
    savefig('ACTB_miRNA_Sim1_1-140-plot3.pdf', transparent=True, bbox_inches='tight')
    ...
    savefig('ACTB_miRNA_Sim1_1-20-plot3.svg',  transparent=True, bbox_inches='tight')
    savefig('ACTB_miRNA_Sim1_1-20-plot3.png',  transparent=True, bbox_inches='tight')
    savefig('ACTB_miRNA_Sim1_1-20-plot3.pdf',  transparent=True, bbox_inches='tight')
    #
