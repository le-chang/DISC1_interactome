...
def make_plot():
    ...
    savefig('ACTB_gene_Sim2_1-140.svg', transparent=True, bbox_inches='tight')
    savefig('ACTB_gene_Sim2_1-140.png', transparent=True, bbox_inches='tight')
    savefig('ACTB_gene_Sim2_1-140.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('ACTB_gene_Sim2_1-20.svg',  transparent=True, bbox_inches='tight')
    savefig('ACTB_gene_Sim2_1-20.png',  transparent=True, bbox_inches='tight')
    savefig('ACTB_gene_Sim2_1-20.pdf',  transparent=True, bbox_inches='tight')
