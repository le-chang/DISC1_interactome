...
def make_plot():
    ...
    legend( ['OE miR33b','OE miR103a', 'OE miR145','OE miR10b', 'OE miR188', 'OE miR143', 'OE miR223','KO miR33b',' KO miR103a', 'KO miR145', 'KO miR10b', 'KO miR188', 'KO miR143', 'KO miR223'], loc='upper center', bbox_to_anchor=(0.5, -0.18), ncol=4, fontsize=7 )
    title( ' Effect of perturbation of miRNAs on migration \n Functional module 6, Simulation 2', fontsize=10  )
    ...
    savefig('ACTB_miRNA_Sim2_1-140_plot1.svg', transparent=True, bbox_inches='tight')
    savefig('ACTB_miRNA_Sim2_1-140_plot1.png', transparent=True, bbox_inches='tight')
    savefig('ACTB_miRNA_Sim2_1-140_plot1.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('ACTB_miRNA_Sim2_1-20_plot1.svg',  transparent=True, bbox_inches='tight')
    savefig('ACTB_miRNA_Sim2_1-20_plot1.png',  transparent=True, bbox_inches='tight')
    savefig('ACTB_miRNA_Sim2_1-20_plot1.pdf',  transparent=True, bbox_inches='tight')
