...
def make_plot():
    ...
    legend( ['OE RXR','OE CCND1', 'OE POU5F1','OE TCF3', 'OE STAT3', 'OE EGR1','KO RXR','KO CCND1', 'KO POU5F1', 'KO TCF3', 'KO STAT3', 'KO EGR1'], loc='upper center', bbox_to_anchor=(0.5, -0.18), ncol=4, fontsize=7 )
    ...
    savefig('ACTB_TF_Sim3_1-140_plot2.svg', transparent=True, bbox_inches='tight')
    savefig('ACTB_TF_Sim3_1-140_plot2.png', transparent=True, bbox_inches='tight')
    savefig('ACTB_TF_Sim3_1-140_plot2.pdf', transparent=True, bbox_inches='tight')
    # ) 
    #
    ...
    savefig('ACTB_TF_Sim3_1-20_plot2.svg',  transparent=True, bbox_inches='tight')
    savefig('ACTB_TF_Sim3_1-20_plot2.png',  transparent=True, bbox_inches='tight')
    savefig('ACTB_TF_Sim3_1-20_plot2.pdf',  transparent=True, bbox_inches='tight')
