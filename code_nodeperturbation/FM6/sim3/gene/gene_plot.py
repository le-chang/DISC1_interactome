...
def make_plot():
    ...
    legend( ['OE ACTB','OE AKT1', 'OE DISC1','OE CCDC88A','KO ACTB','KO AKT1', 'KO DISC1', 'KO CCDC88A'], loc='upper center', bbox_to_anchor=(0.5, -0.15), ncol=4, fontsize=7 )
    ...
    savefig('ACTB_gene_Sim3_1-140.svg', transparent=True, bbox_inches='tight')
    savefig('ACTB_gene_Sim3_1-140.png', transparent=True, bbox_inches='tight')
    savefig('ACTB_gene_Sim3_1-140.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('ACTB_gene_Sim3_1-20.svg',  transparent=True, bbox_inches='tight')
    savefig('ACTB_gene_Sim3_1-20.png',  transparent=True, bbox_inches='tight')
    savefig('ACTB_gene_Sim3_1-20.pdf',  transparent=True, bbox_inches='tight')
