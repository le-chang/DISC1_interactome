...
def make_plot():
    ...
    savefig('ACTB_miRNA_Sim3_1-140_plot2.svg', transparent=True, bbox_inches='tight')
    savefig('ACTB_miRNA_Sim3_1-140_plot2.png', transparent=True, bbox_inches='tight')
    savefig('ACTB_miRNA_Sim3_1-140_plot2.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('ACTB_miRNA_Sim3_1-20_plot2.svg',  transparent=True, bbox_inches='tight')
    savefig('ACTB_miRNA_Sim3_1-20_plot2.png',  transparent=True, bbox_inches='tight')
    savefig('ACTB_miRNA_Sim3_1-20_plot2.pdf',  transparent=True, bbox_inches='tight')
