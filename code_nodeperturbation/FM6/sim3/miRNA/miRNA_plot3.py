...
def make_plot():
    ...
    ylim( (-0.1, 1.1) ) 
    xlim( (-0.1, 140) )
    legend( ['OE miR155','OE miR106a', 'OE miR17','OE miR130a', 'OE miR125b', 'OE miR20b', ' KO miR155 ',' KO miR106a', 'KO miR17', 'KO miR130a', 'KO miR125b', 'KO miR20b'], loc='upper center', bbox_to_anchor=(0.5, -0.18), ncol=4, fontsize=7 )
    ...
    savefig('ACTB_miRNA_Sim3_1-140-plot3.svg', transparent=True, bbox_inches='tight')
    savefig('ACTB_miRNA_Sim3_1-140-plot3.png', transparent=True, bbox_inches='tight')
    savefig('ACTB_miRNA_Sim3_1-140-plot3.pdf', transparent=True, bbox_inches='tight')
    ...
    savefig('ACTB_miRNA_Sim3_1-20-plot3.svg',  transparent=True, bbox_inches='tight')
    savefig('ACTB_miRNA_Sim3_1-20-plot3.png',  transparent=True, bbox_inches='tight')
    savefig('ACTB_miRNA_Sim3_1-20-plot3.pdf',  transparent=True, bbox_inches='tight')
    #
