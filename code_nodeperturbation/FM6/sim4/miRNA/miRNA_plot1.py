...
def make_plot():
    ...
    savefig('ACTB_miRNA_Sim4_1-140_plot1.svg', transparent=True, bbox_inches='tight')
    savefig('ACTB_miRNA_Sim4_1-140_plot1.png', transparent=True, bbox_inches='tight')
    savefig('ACTB_miRNA_Sim4_1-140_plot1.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('ACTB_miRNA_Sim4_1-20_plot1.svg',  transparent=True, bbox_inches='tight')
    savefig('ACTB_miRNA_Sim4_1-20_plot1.png',  transparent=True, bbox_inches='tight')
    savefig('ACTB_miRNA_Sim4_1-20_plot1.pdf',  transparent=True, bbox_inches='tight')
