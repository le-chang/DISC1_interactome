...
def make_plot():
    ...
    ylim( (-0.1, 1.1) ) 
    xlim( (-0.1, 140) )
    legend( ['OE TAL1','OE TCF3', 'OE STAT3','OE CREB1', 'OE KLF4', 'OE POU5F1', 'KO TAL1','KO TCF3', 'KO STAT3', 'KO CREB1', 'KO KLF4', 'KO POU5F1'], loc='upper center', bbox_to_anchor=(0.5, -0.18), ncol=4, fontsize=7 )
    ...
    savefig('SOX10_TF_Sim2_1-140-plot1.svg', transparent=True, bbox_inches='tight')
    savefig('SOX10_TF_Sim2_1-140-plot1.png', transparent=True, bbox_inches='tight')
    savefig('SOX10_TF_Sim2_1-140-plot1.pdf', transparent=True, bbox_inches='tight')
    ...
    savefig('SOX10_TF_Sim2_1-20-plot1.svg',  transparent=True, bbox_inches='tight')
    savefig('SOX10_TF_Sim2_1-20-plot1.png',  transparent=True, bbox_inches='tight')
    savefig('SOX10_TF_Sim2_1-20-plot1.pdf',  transparent=True, bbox_inches='tight')
    #
    # Plotting Migration (OFF)
    #
    #subplot(122)
