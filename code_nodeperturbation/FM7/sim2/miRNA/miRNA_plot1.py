...
def make_plot():
    ...
    ylim( (-0.1, 1.1) ) 
    xlim( (-0.1, 140) )
    legend( ['OE miR320a','OE miR223', 'OE miR155','OE miR106a', 'OE miR17', 'OE miR130a', 'KO miR320a','KO miR223', 'KO miR155', 'KO miR106a', 'KO miR17', 'KO miR130a'], loc='upper center', bbox_to_anchor=(0.5, -0.18), ncol=4, fontsize=7 )
    title( ' Effect of perturbation of miRNAs on migration \n Functional module 7, Simulation 2', fontsize=10 )
    ...
    savefig('SOX10_miRNA_Sim2_1-140-plot1.svg', transparent=True, bbox_inches='tight')
    savefig('SOX10_miRNA_Sim2_1-140-plot1.png', transparent=True, bbox_inches='tight')
    savefig('SOX10_miRNA_Sim2_1-140-plot1.pdf', transparent=True, bbox_inches='tight')
    ...
    savefig('SOX10_miRNA_Sim2_1-20-plot1.svg',  transparent=True, bbox_inches='tight')
    savefig('SOX10_miRNA_Sim2_1-20-plot1.png',  transparent=True, bbox_inches='tight')
    savefig('SOX10_miRNA_Sim2_1-20-plot1.pdf',  transparent=True, bbox_inches='tight')
    #
    # Plotting Migration (OFF)
    #
    #subplot(122)
