...
def make_plot():
    ...
    savefig('SOX10_TF_Sim4_1-140-plot1.svg', transparent=True, bbox_inches='tight')
    savefig('SOX10_TF_Sim4_1-140-plot1.png', transparent=True, bbox_inches='tight')
    savefig('SOX10_TF_Sim4_1-140-plot1.pdf', transparent=True, bbox_inches='tight')
    ...
    savefig('SOX10_TF_Sim4_1-20-plot1.svg',  transparent=True, bbox_inches='tight')
    savefig('SOX10_TF_Sim4_1-20-plot1.png',  transparent=True, bbox_inches='tight')
    savefig('SOX10_TF_Sim4_1-20-plot1.pdf',  transparent=True, bbox_inches='tight')
    #
    # Plotting Migration (OFF)
    #
    #subplot(122)
