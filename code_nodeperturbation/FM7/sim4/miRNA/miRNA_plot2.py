...
def make_plot():
    ...
    ylim( (-0.1, 1.1) ) 
    xlim( (-0.1, 140) )
    legend(['OE miR125b','OE miR20b','OE miR33b','OE miR145','OE miR10b','OE miR20a','KO miR125b','KO miR20b', 'KO miR33b', 'KO miR145', 'KO miR10b','KO miR20a' ], loc='upper center', bbox_to_anchor=(0.5, -0.18), ncol=4, fontsize=7 )
    ...
    savefig('SOX10_miRNA_Sim4_1-140-plot2.svg', transparent=True, bbox_inches='tight')
    savefig('SOX10_miRNA_Sim4_1-140-plot2.png', transparent=True, bbox_inches='tight')
    savefig('SOX10_miRNA_Sim4_1-140-plot2.pdf', transparent=True, bbox_inches='tight')
    ...
    savefig('SOX10_miRNA_Sim4_1-20-plot2.svg',  transparent=True, bbox_inches='tight')
    savefig('SOX10_miRNA_Sim4_1-20-plot2.png',  transparent=True, bbox_inches='tight')
    savefig('SOX10_miRNA_Sim4_1-20-plot2.pdf',  transparent=True, bbox_inches='tight')
    #
    # Plotting Migration (OFF)
    #
    #subplot(122)
