...
def make_plot():
    ...
    ylim( (-0.1, 1.1) ) 
    xlim( (-0.1, 140) )
    legend( ['OE CCND1','OE CREB1', 'OE KLF4','OE TCF3', 'OE TAL1','KO CCND1','KO CREB1', 'KO KLF4', 'KO TCF3', 'KO TAL1'], loc='upper center', bbox_to_anchor=(0.5, -0.15), ncol=5, fontsize=7)
    title( ' Effect of perturbation of TFs on migration \n Functional module 8, Simulation 1', fontsize=10 )
    ...
    savefig('RHEB_TF_Sim1_1-140_plot1.svg', transparent=True, bbox_inches='tight')
    savefig('RHEB_TF_Sim1_1-140_plot1.png', transparent=True, bbox_inches='tight')
    savefig('RHEB_TF_Sim1_1-140_plot1.pdf', transparent=True, bbox_inches='tight')
    ...
    savefig('RHEB_TF_Sim1_1-20_plot1.svg', transparent=True, bbox_inches='tight')
    savefig('RHEB_TF_Sim1_1-20_plot1.png', transparent=True, bbox_inches='tight')
    savefig('RHEB_TF_Sim1_1-20_plot1.pdf', transparent=True, bbox_inches='tight')
