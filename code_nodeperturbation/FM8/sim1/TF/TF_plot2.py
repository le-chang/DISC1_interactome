...
def make_plot():
    ...
    legend( ['OE SMAD2','OE SMAD3', 'OE POU5F1','OE STAT3', 'KO SMAD2','KO SMAD3', 'KO POU5F1', 'KO STAT3'], loc='upper center', bbox_to_anchor=(0.5, -0.15), ncol=4, fontsize=7 )
    ylim( (-0.1, 1.1) ) 
    xlim( (-0.1, 140) ) 
    ...
    savefig('RHEB_TF_Sim1_1-140_plot2.svg', transparent=True, bbox_inches='tight')
    savefig('RHEB_TF_Sim1_1-140_plot2.png', transparent=True, bbox_inches='tight')
    savefig('RHEB_TF_Sim1_1-140_plot2.pdf', transparent=True, bbox_inches='tight')
    ...
    savefig('RHEB_TF_Sim1_1-20_plot2.svg', transparent=True, bbox_inches='tight')
    savefig('RHEB_TF_Sim1_1-20_plot2.png', transparent=True, bbox_inches='tight')
    savefig('RHEB_TF_Sim1_1-20_plot2.pdf', transparent=True, bbox_inches='tight')
