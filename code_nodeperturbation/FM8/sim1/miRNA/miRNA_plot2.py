...
def make_plot():
    ...
    savefig('RHEB_miRNA_Sim1_1-140_plot2.svg', transparent=True, bbox_inches='tight')
    savefig('RHEB_miRNA_Sim1_1-140_plot2.png', transparent=True, bbox_inches='tight')
    savefig('RHEB_miRNA_Sim1_1-140_plot2.pdf', transparent=True, bbox_inches='tight')
    #
    ...
    savefig('RHEB_miRNA_Sim1_1-20_plot2.svg',  transparent=True, bbox_inches='tight')
    savefig('RHEB_miRNA_Sim1_1-20_plot2.png',  transparent=True, bbox_inches='tight')
    savefig('RHEB_miRNA_Sim1_1-20_plot2.pdf',  transparent=True, bbox_inches='tight')
